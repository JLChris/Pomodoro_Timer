...
function Pomodoro() {
  ...
  // put focus and breakDuration in state
  ...
  return (
    <div className="pomodoro">
          ...
          <div className="input-group input-group-lg mb-2">
            ...
            <div className="input-group-append">
              ...
              <button
                ...
                onClick={() => {
                  let newDuration = durations.focus - 5;
                  if (newDuration < 5) newDuration = 5;
                  setDurations({ ...durations, focus: newDuration });
                }}
                disabled={session}
              >
            ...
            <div className="input-group input-group-lg mb-2">
              ...
              <div className="input-group-append">
                ...
                <button
                  ...
                  onClick={() => {
                    let newDuration = durations.break - 1;
                    if (newDuration < 1) newDuration = 1;
                    setDurations({ ...durations, break: newDuration });
                  }}
                  disabled={session}
                >
                  <span className="oi oi-minus" />
      ...
      <div>
        ...
        <TimerDisplay session={session} durations={durations} isTimerRunning={isTimerRunning} />
      </div>
    </div>
  );
}
